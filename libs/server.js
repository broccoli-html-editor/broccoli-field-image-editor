        ...
        it79.fnc(
          data, [
            ...
            function(it1, data) {
              ...
              var _html = '<style>.psdrb_html_generator .img_link{opacity:0; background:rgba(204,204,204,0.7);}</style><div class="psdrb_html_generator" style="position:relative;margin:0;padding:0;<%= maxWidth %>;"><img src="<%- imgFile %>" alt=""><%= link_html %></div>';
//               var _html = (function() {/*
// <style>
